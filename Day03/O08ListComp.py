...
words = [len(word) for word in sentence.split()]
print(f"words :{words}")
...
print("-" * 40)
price = [(fruit[1], fruit[1] * 0.9, fruit[1] * 0.75) for fruit in fruits]
print(price)

print("-" * 40)
expnFrts = [(fruit[0], fruit[1], fruit[1]*0.9, fruit[1]*0.75) for fruit in fruits if fruit[1] > 100]
print(f"expnFrt :{expnFrts}")
